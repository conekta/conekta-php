 ...
 */
class CustomerShippingContactsAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customer_shipping_contacts_address';
