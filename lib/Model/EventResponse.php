...
class EventResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('webhook_logs', $data ?? [], null);
        $this->setIfExists('webhook_status', $data ?? [], null);
    }
    ...
    */
    ...
    public function setData($data)
    {
        ...
        if ((count($data) > 100)) {
            throw new \InvalidArgumentException('invalid value for $data when calling EventResponse., number of items must be less than or equal to 100.');
        }
     ...
     * Gets webhook_logs
     *
     * @return \Conekta\Model\WebhookLog[]|null
     */
    public function getWebhookLogs()
    {
        return $this->container['webhook_logs'];
    }

    /**
     * Sets webhook_logs
     *
     * @param \Conekta\Model\WebhookLog[]|null $webhook_logs webhook_logs
     *
     * @return self
     */
    public function setWebhookLogs($webhook_logs)
    {
        if (is_null($webhook_logs)) {
            throw new \InvalidArgumentException('non-nullable webhook_logs cannot be null');
        }
        $this->container['webhook_logs'] = $webhook_logs;
    ...
    {
        return $this->container['webhook_status'];
    }
     ...
     * @return self
     */
    public function setWebhookStatus($webhook_status)
    {
        if (is_null($webhook_status)) {
            throw new \InvalidArgumentException('non-nullable webhook_status cannot be null');
        }
        $this->container['webhook_status'] = $webhook_status;
