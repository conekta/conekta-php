    ...
    */
    ...
    public function setContractId($contract_id)
    {
        ...
        if ((mb_strlen($contract_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $contract_id when calling ChargeOrderResponsePaymentMethod., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($contract_id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $contract_id when calling ChargeOrderResponsePaymentMethod., must be bigger than or equal to 10.');
        }
