...
class CreateCustomerPaymentMethodsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets token_id
     *
     * @param string $token_id Token id that will be used to create a \"card\" type payment method. See the (subscriptions)[https://developers.conekta.com/v2.3.0/reference/createsubscription] tutorial for more information on how to tokenize cards.
     *
     * @return self
     */
