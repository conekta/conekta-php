...
class WebhookResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description A name or brief explanation of what this webhook is used for
     *
     * @return self
     */
     ...
     * Sets livemode
     *
     * @param bool|null $livemode Indicates if the webhook is in production
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool|null $active Indicates if the webhook is actived or not
     *
     * @return self
     */
     ...
     * Sets object
     *
     * @param string|null $object Object name, value is 'webhook'
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Indicates if the webhook is ready to receive events or failing
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $subscribed_events lists the events that will be sent to the webhook
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url url or endpoint of the webhook
     *
     * @return self
     */
