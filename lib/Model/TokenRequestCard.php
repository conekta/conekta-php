...
/**
 * TokenRequestCard Class Doc Comment
 *
 * @category Class
 * @package  Conekta
 * @author   OpenAPI Generator team
 ...
 */
class TokenRequestCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'token_request_card';
    ...
    */
    ...
    public function setCvc($cvc)
    {
        ...
        if ((mb_strlen($cvc) > 4)) {
            throw new \InvalidArgumentException('invalid length for $cvc when calling TokenRequestCard., must be smaller than or equal to 4.');
        }
    ...
    public function setExpMonth($exp_month)
    {
        ...
        if ((mb_strlen($exp_month) > 2)) {
            throw new \InvalidArgumentException('invalid length for $exp_month when calling TokenRequestCard., must be smaller than or equal to 2.');
        }
    ...
    public function setExpYear($exp_year)
    {
        ...
        if ((mb_strlen($exp_year) > 2)) {
            throw new \InvalidArgumentException('invalid length for $exp_year when calling TokenRequestCard., must be smaller than or equal to 2.');
        }
