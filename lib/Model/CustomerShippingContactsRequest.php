...
/**
 * CustomerShippingContactsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerShippingContactsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customer_shipping_contacts_request';
    ...
    */
    ...
    public function setMetadata($metadata)
    {
        ...
        if ((count($metadata) > 100)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling CustomerShippingContactsRequest., number of items must be less than or equal to 100.');
        }
