...
class Checkout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string[]|null $allowed_payment_methods Those are the payment methods that will be available for the link. This field is mutually exclusive with excluded_payment_methods.
     *
     * @return self
     */
