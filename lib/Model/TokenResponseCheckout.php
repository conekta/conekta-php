...
class TokenResponseCheckout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets can_not_expire
     *
     * @param bool|null $can_not_expire Indicates if the checkout can not expire.
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param int|null $expires_at Date and time when the checkout expires.
     *
     * @return self
     */
     ...
     * Sets failure_url
     *
     * @param string|null $failure_url URL to redirect the customer to if the payment process fails.
     *
     * @return self
     */
     ...
     * Sets force_3ds_flow
     *
     * @param bool|null $force_3ds_flow Indicates if the checkout forces the 3DS flow.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $monthly_installments_enabled Indicates if the checkout allows monthly installments.
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $monthly_installments_options List of monthly installments options.
     *
     * @return self
     */
     ...
     * Sets object
     *
     * @param string|null $object Indicates the type of object, in this case checkout.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $on_demand_enabled Indicates if the checkout allows on demand payments.
     *
     * @return self
     */
     ...
     *
     * @param int|null $paid_payments_count Number of payments that have been paid.
     *
     * @return self
     */
     ...
     * Sets recurrent
     *
     * @param bool|null $recurrent Indicates if the checkout is recurrent.
     *
     * @return self
     */
     ...
     * Sets starts_at
     *
     * @param int|null $starts_at Date and time when the checkout starts.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Status of the checkout.
     *
     * @return self
     */
     ...
     * Sets success_url
     *
     * @param string|null $success_url URL to redirect the customer to after the payment process is completed.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type of checkout.
     *
     * @return self
     */
