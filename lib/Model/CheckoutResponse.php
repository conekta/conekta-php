...
class CheckoutResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string[]|null $excluded_payment_methods Payment methods excluded from the checkout. This field is only returned when excluded_payment_methods is provided in the request.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $exclude_card_networks exclude_card_networks
     *
     * @return self
     */
