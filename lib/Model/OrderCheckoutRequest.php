 ...
 *
 * @category Class
 * @description [Checkout](https://developers.conekta.com/v2.3.0/reference/payment-link) details
 * @package  Conekta
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class OrderCheckoutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'order_checkout_request';
    ...
    public const EXCLUDED_PAYMENT_METHODS_CASH = 'cash';
    public const EXCLUDED_PAYMENT_METHODS_CARD = 'card';
    public const EXCLUDED_PAYMENT_METHODS_BANK_TRANSFER = 'bank_transfer';
    public const EXCLUDED_PAYMENT_METHODS_BNPL = 'bnpl';
    public const EXCLUDED_PAYMENT_METHODS_PAY_BY_BANK = 'pay_by_bank';
    ...
    public const TYPE_HOSTED_PAYMENT = 'HostedPayment';
     ...
     * @return string[]
     */
    public function getExcludedPaymentMethodsAllowableValues()
    {
        return [
            self::EXCLUDED_PAYMENT_METHODS_CASH,
            self::EXCLUDED_PAYMENT_METHODS_CARD,
            self::EXCLUDED_PAYMENT_METHODS_BANK_TRANSFER,
            self::EXCLUDED_PAYMENT_METHODS_BNPL,
            self::EXCLUDED_PAYMENT_METHODS_PAY_BY_BANK,
        ];
    }
     ...
     *
     * @param string[]|null $allowed_payment_methods Are the payment methods available for this link. For subscriptions, only 'card' is allowed due to the recurring nature of the payments. This field is mutually exclusive with excluded_payment_methods.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $excluded_payment_methods Payment methods to be excluded from the checkout. This field is mutually exclusive with allowed_payment_methods.
     *
     * @return self
     */
    public function setExcludedPaymentMethods($excluded_payment_methods)
    {
        ...
        $allowedValues = $this->getExcludedPaymentMethodsAllowableValues();
        if (array_diff($excluded_payment_methods, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'excluded_payment_methods', must be one of '%s'",
                    implode("', '", $allowedValues)
                )
            );
        }
     ...
     * Sets type
     *
     * @param string|null $type Required. This field represents the type of checkout, which determines the user experience during the payment process. 'HostedPayment' will redirect the customer to a Conekta-hosted page to complete the payment, while 'Integration' allows the payment process to be handled entirely on your site using Conekta's APIs and SDKs.
     *
     * @return self
     */
