 ...
 */
class CustomerResponseShippingContacts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customer_response_shipping_contacts';
