...
/**
 * OrdersUpdateTaxesRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class OrdersUpdateTaxesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ordersUpdateTaxes_request';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling OrdersUpdateTaxesRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 2)) {
            throw new \InvalidArgumentException('invalid length for $description when calling OrdersUpdateTaxesRequest., must be bigger than or equal to 2.');
        }
    ...
    public function setMetadata($metadata)
    {
        ...
        if (!is_null($metadata) && (count($metadata) > 100)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling OrdersUpdateTaxesRequest., number of items must be less than or equal to 100.');
        }
