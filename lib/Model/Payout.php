...
class Payout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'payout_method' => '\Conekta\Model\PayoutMethod'
    ];
    ...
    {
        $this->setIfExists('payout_method', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets payout_method
     *
     * @return \Conekta\Model\PayoutMethod
     */
     ...
     * Sets payout_method
     *
     * @param \Conekta\Model\PayoutMethod $payout_method payout_method
     *
     * @return self
     */
    public function setPayoutMethod($payout_method)
    {
        if (is_null($payout_method)) {
            throw new \InvalidArgumentException('non-nullable payout_method cannot be null');
        }
