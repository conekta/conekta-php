...
class OrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets charges
     *
     * @param \Conekta\Model\ChargeRequest[]|null $charges List of [charges](https://developers.conekta.com/v2.3.0/reference/orderscreatecharge) that are applied to the order
     *
     * @return self
     */
     ...
     * Sets discount_lines
     *
     * @param \Conekta\Model\OrderDiscountLinesRequest[]|null $discount_lines List of [discounts](https://developers.conekta.com/v2.3.0/reference/orderscreatediscountline) that are applied to the order.
     *
     * @return self
     */
     ...
     * Sets line_items
     *
     * @param \Conekta\Model\Product[] $line_items List of [products](https://developers.conekta.com/v2.3.0/reference/orderscreateproduct) that are sold in the order. You must have at least one product.
     *
     * @return self
     */
     ...
     * Sets shipping_lines
     *
     * @param \Conekta\Model\ShippingRequest[]|null $shipping_lines List of [shipping costs](https://developers.conekta.com/v2.3.0/reference/orderscreateshipping). If the online store offers digital products.
     *
     * @return self
     */
     ...
     * Sets tax_lines
     *
     * @param \Conekta\Model\OrderTaxRequest[]|null $tax_lines List of [taxes](https://developers.conekta.com/v2.3.0/reference/orderscreatetaxes) that are applied to the order.
     *
     * @return self
     */
