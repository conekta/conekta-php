...
/**
 * UpdatesASubscription Class Doc Comment
 *
 * @category Class
 * @description You can modify the subscription to change the plan used by your customers.
 * @package  Conekta
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdatesASubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updates_a_subscription';
