...
/**
 * CustomerUpdateShippingContactsRequest Class Doc Comment
 *
 * @category Class
 * @description [Shipping](https://developers.conekta.com/v2.2.0/reference/createcustomershippingcontacts) details, required in case of sending a shipping. If we do not receive a shipping_contact on the order, the default shipping_contact of the customer will be used.
 * @package  Conekta
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomerUpdateShippingContactsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customer_update_shipping_contacts_request';
    ...
    */
     ...
     * Gets address
     *
     * @return \Conekta\Model\CustomerShippingContactsRequestAddress|null
     */
     ...
     * Sets address
     *
     * @param \Conekta\Model\CustomerShippingContactsRequestAddress|null $address address
     *
     * @return self
     */
