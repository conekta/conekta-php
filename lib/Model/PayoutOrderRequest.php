...
/**
 * PayoutOrderRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PayoutOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'payout_order_request';
    ...
    protected static $openAPITypes = [
        ...
        'amount' => 'int',
        'currency' => 'string',
        'customer_info' => '\Conekta\Model\PayoutOrderRequestCustomerInfo',
        'expires_at' => 'int',
    ...
    */
     ...
     * Gets customer_info
     *
     * @return \Conekta\Model\PayoutOrderRequestCustomerInfo
     */
     ...
     * Sets customer_info
     *
     * @param \Conekta\Model\PayoutOrderRequestCustomerInfo $customer_info customer_info
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param int $expires_at The expiration time of the payout order in Unix timestamp.
     *
     * @return self
     */
    ...
    public function setMetadata($metadata)
    {
        ...
        if ((count($metadata) > 100)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling PayoutOrderRequest., number of items must be less than or equal to 100.');
        }
