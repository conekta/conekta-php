 ...
 */
class UpdateWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_webhook';
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url Here you must place the URL of your Webhook remember that you must program what you will do with the events received. Also do not forget to handle the HTTPS protocol for greater security.
     *
     * @return self
     */
    public function setUrl($url)
    {
        ...
        if ((!preg_match("/^(?!.*(localhost|127\\.0\\.0\\.1)).*$/", ObjectSerializer::toString($url)))) {
            throw new \InvalidArgumentException("invalid value for \$url when calling UpdateWebhook., must conform to the pattern /^(?!.*(localhost|127\\.0\\.0\\.1)).*$/.");
        }
     ...
     *
     * @param string[]|null $subscribed_events events that will be sent to the webhook
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool|null $active whether the webhook is active or not
     *
     * @return self
     */
