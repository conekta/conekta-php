...
class OrderUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'order_update';
    ...
    protected static $openAPITypes = [
        ...
        'currency' => 'string',
        'customer_info' => '\Conekta\Model\OrderUpdateCustomerInfo',
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling OrderUpdate., must be smaller than or equal to 3.');
        }
     ...
     * Gets customer_info
     *
     * @return \Conekta\Model\OrderUpdateCustomerInfo|null
     */
     ...
     * Sets customer_info
     *
     * @param \Conekta\Model\OrderUpdateCustomerInfo|null $customer_info customer_info
     *
     * @return self
     */
     ...
     * Sets line_items
     *
     * @param \Conekta\Model\Product[]|null $line_items List of [products](https://developers.conekta.com/v2.3.0/reference/orderscreateproduct) that are sold in the order. You must have at least one product.
     *
     * @return self
     */
