...
class OrderUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets line_items
     *
     * @param \Conekta\Model\Product[]|null $line_items List of [products](https://developers.conekta.com/v2.2.0/reference/orderscreateproduct) that are sold in the order. You must have at least one product.
     *
     * @return self
     */
