...
class TransactionsApi
{
     ...
     * @param  string|null $id id of the object to be retrieved (optional)
     * @param  string|null $charge_id id of the charge used for filtering (optional)
     * @param  string|null $type type of the object to be retrieved (optional)
