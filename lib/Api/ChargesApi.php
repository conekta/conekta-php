...
class ChargesApi
{
     ...
     * @return \Conekta\Model\GetChargesResponse|\Conekta\Model\Error|\Conekta\Model\Error
     */
     ...
     * @throws \Conekta\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Conekta\Model\GetChargesResponse|\Conekta\Model\Error|\Conekta\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChargesWithHttpInfo($accept_language = 'es', $x_child_company_id = null, $limit = 20, $search = null, $next = null, $previous = null, string $contentType = self::contentTypes['getCharges'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Conekta\Model\GetChargesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Conekta\Model\GetChargesResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Conekta\Model\GetChargesResponse', []),
     ...
     * @throws \Conekta\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Conekta\Model\ChargeOrderResponse|\Conekta\Model\Error|\Conekta\Model\Error|\Conekta\Model\Error|\Conekta\Model\Error
     */
     ...
     * @throws \Conekta\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Conekta\Model\ChargeOrderResponse|\Conekta\Model\Error|\Conekta\Model\Error|\Conekta\Model\Error|\Conekta\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function ordersCreateChargeWithHttpInfo($id, $charge_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['ordersCreateCharge'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Conekta\Model\ChargeOrderResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Conekta\Model\ChargeOrderResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Conekta\Model\ChargeOrderResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Conekta\Model\ChargeOrderResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Conekta\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Conekta\Model\ChargesOrderResponse|\Conekta\Model\Error|\Conekta\Model\Error|\Conekta\Model\Error|\Conekta\Model\Error
     */
    public function ordersCreateCharges($id, $charge_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['ordersCreateCharges'][0])
    {
        list($response) = $this->ordersCreateChargesWithHttpInfo($id, $charge_request, $accept_language, $x_child_company_id, $contentType);
        return $response;
    }

    /**
     * Operation ordersCreateChargesWithHttpInfo
     *
     * Create charges
     *
     * @param  string $id Identifier of the resource (required)
     ...
     * @throws \Conekta\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Conekta\Model\ChargesOrderResponse|\Conekta\Model\Error|\Conekta\Model\Error|\Conekta\Model\Error|\Conekta\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function ordersCreateChargesWithHttpInfo($id, $charge_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['ordersCreateCharges'][0])
    {
        $request = $this->ordersCreateChargesRequest($id, $charge_request, $accept_language, $x_child_company_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Conekta\Model\ChargesOrderResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Conekta\Model\ChargesOrderResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Conekta\Model\ChargesOrderResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    /**
     * Operation ordersCreateChargesAsync
     *
     * Create charges
     *
     * @param  string $id Identifier of the resource (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ordersCreateChargesAsync($id, $charge_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['ordersCreateCharges'][0])
    {
        return $this->ordersCreateChargesAsyncWithHttpInfo($id, $charge_request, $accept_language, $x_child_company_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ordersCreateChargesAsyncWithHttpInfo
     *
     * Create charges
     *
     * @param  string $id Identifier of the resource (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ordersCreateChargesAsyncWithHttpInfo($id, $charge_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['ordersCreateCharges'][0])
    {
        $returnType = '\Conekta\Model\ChargesOrderResponse';
        $request = $this->ordersCreateChargesRequest($id, $charge_request, $accept_language, $x_child_company_id, $contentType);
    ...
    /**
     * Create request for operation 'ordersCreateCharges'
     *
     * @param  string $id Identifier of the resource (required)
     * @param  \Conekta\Model\ChargeRequest $charge_request requested field for a charge (required)
     * @param  string $accept_language Use for knowing which language to use (optional, default to 'es')
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ordersCreateChargesRequest($id, $charge_request, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['ordersCreateCharges'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling ordersCreateCharges'
            );
        }
        ...
        if ($charge_request === null || (is_array($charge_request) && count($charge_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $charge_request when calling ordersCreateCharges'
            );
        }
        ...
        $resourcePath = '/orders/{id}/add_charges';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
