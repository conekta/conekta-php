...
/**
    ...
    /**
     * Operation getAllEventsFromSubscription
     *
     ...
     */
    public function getAllEventsFromSubscription($id, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['getAllEventsFromSubscription'][0])
    {
        list($response) = $this->getAllEventsFromSubscriptionWithHttpInfo($id, $accept_language, $x_child_company_id, $contentType);
        return $response;
    }

    /**
     * Operation getAllEventsFromSubscriptionWithHttpInfo
     *
     * Get Events By Subscription
     *
     * @param  string $id Identifier of the resource (required)
     ...
     */
    public function getAllEventsFromSubscriptionWithHttpInfo($id, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['getAllEventsFromSubscription'][0])
    {
        $request = $this->getAllEventsFromSubscriptionRequest($id, $accept_language, $x_child_company_id, $contentType);
    ...
    /**
     * Operation getAllEventsFromSubscriptionAsync
     *
     * Get Events By Subscription
     *
     * @param  string $id Identifier of the resource (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllEventsFromSubscriptionAsync($id, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['getAllEventsFromSubscription'][0])
    {
        return $this->getAllEventsFromSubscriptionAsyncWithHttpInfo($id, $accept_language, $x_child_company_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAllEventsFromSubscriptionAsyncWithHttpInfo
     *
     * Get Events By Subscription
     *
     * @param  string $id Identifier of the resource (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllEventsFromSubscriptionAsyncWithHttpInfo($id, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['getAllEventsFromSubscription'][0])
    {
        $returnType = '\Conekta\Model\SubscriptionEventsResponse';
        $request = $this->getAllEventsFromSubscriptionRequest($id, $accept_language, $x_child_company_id, $contentType);
    ...
    /**
     * Create request for operation 'getAllEventsFromSubscription'
     *
     * @param  string $id Identifier of the resource (required)
     * @param  string $accept_language Use for knowing which language to use (optional, default to 'es')
     * @param  string $x_child_company_id In the case of a holding company, the company id of the child company to which will process the request. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllEventsFromSubscriptionRequest($id, $accept_language = 'es', $x_child_company_id = null, string $contentType = self::contentTypes['getAllEventsFromSubscription'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getAllEventsFromSubscription'
            );
        }
