...
class OrdersApi
{
     ...
     */
    public function getOrders($accept_language = 'es', $x_child_company_id = null, $limit = 20, $search = null, $next = null, $previous = null, $payment_status = null, $last_payment_info_status = null, $created_at = null, $created_at_gte = null, $created_at_lte = null, $updated_at_gte = null, $updated_at_lte = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        list($response) = $this->getOrdersWithHttpInfo($accept_language, $x_child_company_id, $limit, $search, $next, $previous, $payment_status, $last_payment_info_status, $created_at, $created_at_gte, $created_at_lte, $updated_at_gte, $updated_at_lte, $contentType);
        return $response;
    }
     ...
     */
    public function getOrdersWithHttpInfo($accept_language = 'es', $x_child_company_id = null, $limit = 20, $search = null, $next = null, $previous = null, $payment_status = null, $last_payment_info_status = null, $created_at = null, $created_at_gte = null, $created_at_lte = null, $updated_at_gte = null, $updated_at_lte = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        $request = $this->getOrdersRequest($accept_language, $x_child_company_id, $limit, $search, $next, $previous, $payment_status, $last_payment_info_status, $created_at, $created_at_gte, $created_at_lte, $updated_at_gte, $updated_at_lte, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrdersAsync($accept_language = 'es', $x_child_company_id = null, $limit = 20, $search = null, $next = null, $previous = null, $payment_status = null, $last_payment_info_status = null, $created_at = null, $created_at_gte = null, $created_at_lte = null, $updated_at_gte = null, $updated_at_lte = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        return $this->getOrdersAsyncWithHttpInfo($accept_language, $x_child_company_id, $limit, $search, $next, $previous, $payment_status, $last_payment_info_status, $created_at, $created_at_gte, $created_at_lte, $updated_at_gte, $updated_at_lte, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrdersAsyncWithHttpInfo($accept_language = 'es', $x_child_company_id = null, $limit = 20, $search = null, $next = null, $previous = null, $payment_status = null, $last_payment_info_status = null, $created_at = null, $created_at_gte = null, $created_at_lte = null, $updated_at_gte = null, $updated_at_lte = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        $returnType = '\Conekta\Model\GetOrdersResponse';
        $request = $this->getOrdersRequest($accept_language, $x_child_company_id, $limit, $search, $next, $previous, $payment_status, $last_payment_info_status, $created_at, $created_at_gte, $created_at_lte, $updated_at_gte, $updated_at_lte, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrdersRequest($accept_language = 'es', $x_child_company_id = null, $limit = 20, $search = null, $next = null, $previous = null, $payment_status = null, $last_payment_info_status = null, $created_at = null, $created_at_gte = null, $created_at_lte = null, $updated_at_gte = null, $updated_at_lte = null, string $contentType = self::contentTypes['getOrders'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'last_payment_info.status', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
