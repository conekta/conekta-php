...
class ApiKeysApi
{
     ...
     * @param  string|null $search General search, e.g. by id, description, prefix (optional)
     ...
     * @param  string $id Identifier of the resource (required)
     * @param  string|null $accept_language Use for knowing which language to use (optional, default to 'es')
     * @param  \Conekta\Model\ApiKeyUpdateRequest|null $api_key_update_request api_key_update_request (optional)
     ...
     * @param  string $id Identifier of the resource (required)
     * @param  string|null $accept_language Use for knowing which language to use (optional, default to 'es')
     * @param  \Conekta\Model\ApiKeyUpdateRequest|null $api_key_update_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateApiKey'] to see the possible values for this operation
     *
     * @throws \Conekta\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
