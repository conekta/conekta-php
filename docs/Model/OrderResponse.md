...
**discount_lines** | [**\Conekta\Model\DiscountLinesResponse[]**](DiscountLinesResponse.md) | List of discounts that are applied to the order | [optional]
**tax_lines** | [**\Conekta\Model\OrderTaxResponse[]**](OrderTaxResponse.md) | List of taxes that are applied to the order | [optional]
